...
#  else
#    if _MSC_VER && !__INTEL_COMPILER
#      pragma message("Can t find cuda_runtime.h, disable CUDA module")
#    else
#      warning Can t find cuda_runtime.h, disable CUDA module.
#    endif
#  endif
#endif
...
#  if _MSC_VER && !__INTEL_COMPILER
#    pragma message("NC++17 is not enabled, the program will be less efficient with previous standards")
#  else
