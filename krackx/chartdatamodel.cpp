...
MyDataModel::MyDataModel() {
  QObject::connect(this, &MyDataModel::newPointAdded, this,
                   &MyDataModel::addNewPoint, Qt::QueuedConnection);
}
...
QVariant MyDataModel::headerData(int section, Qt::Orientation orientation,
                                 int role) const {
