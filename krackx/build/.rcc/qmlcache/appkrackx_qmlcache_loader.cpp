...
Registry::Registry() {
        ...
        resourcePathToCachedUnit.insert(QStringLiteral("/krackx/counter.qml"), &QmlCacheGeneratedCode::_krackx_counter_qml::unit);
        resourcePathToCachedUnit.insert(QStringLiteral("/krackx/GTA_SA.qml"), &QmlCacheGeneratedCode::_krackx_GTA_SA_qml::unit);
